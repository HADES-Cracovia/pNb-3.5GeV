...
int main(Int_t argc, Char_t **argv)
{
  ...
  ////******************************************************
  //TString inputDir;
  TString inputDir  ="/lustre/nyx/hades/dst/sep08_BT/gen2/288/root/";
  //TString inputDir  ="/lustre/nyx/hades/user/kempter/dst/sep08_BT/gen1/288/root/";
  //TString inputDir  ="/lustre/nyx/hades/dst/aug14/gen2/237/690/root/";
  ////******************************************************
  ////******************************************************
  ...
  //*******************************************
  //*******************************************
  TString output_Dir ="/lustre/nyx/hades/user/knowakow/PNB/PAT_PNB/FILES/";
  ...
  myParticles.add("all",eHadronPos);
  ...
  //***------- hadron stuff ---------------------------
#ifdef HADRONS
    myPids2.add("Hp", "P",eProton);
    myPids2.add("Hp", "D",eDeuteron);
    myPids2.add("Hp", "T",eTritium);
    myPids2.add("Hp", "He3",eHe3);
    myPids2.add("Hp", "Alpha",eAlpha);
  ...
  //***------- hadron stuff ---------------------------
#ifdef HADRONS
    myPids_A2.add("Hp", "P_ID",eProton);
    myPids_A2.add("Hp", "D_ID",eDeuteron);
    myPids_A2.add("Hp", "T_ID",eTritium);
    myPids_A2.add("Hp", "He3_ID",eHe3);
    myPids_A2.add("Hp", "Alpha_ID",eAlpha);
