...
EParticle CommonDefinitions::convertId(const char* name)
{
   ...
   else if (tmp_name == "t") return eTritium;
   else if (tmp_name == "alpha") return eAlpha;
   else if (tmp_name == "he3") return eHe3;
...
EParticle CommonDefinitions::convertId(int n)
{
   ...
   else if (n == 46) return eTritium;
   else if (n == 47) return eAlpha;
   else if (n == 49) return eHe3;
...
std::string CommonDefinitions::convertId(CommonDefinitions::EParticle eid)
{
   ...
   else if (eid == eTritium) return "t";
   else if (eid == eAlpha) return "alpha";
   else if (eid == eHe3) return "he3";
