...
submissiondir=${submmissionbase}/PAT_epem
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PNB/PAT_epem/FILES/sep08_all/list3/    # outputdir for files AND logFiles
...
filelist=${currentDir}/file3.list  # file list in local dir! not in submissiondir!!!
