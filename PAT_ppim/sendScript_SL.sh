...
submmissionbase=/lustre/nyx/hades/user/knowakow/PNB
submissiondir=${submmissionbase}/PAT_ppim
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PNB/PAT_ppim/FILES/full_stat_1/     # outputdir for files AND logFiles
...
par2=${submissiondir}/ana1                           # optional par2 : executable
...
filelist=${currentDir}/zepsute_out.list  # file list in local dir! not in submissiondir!!!
