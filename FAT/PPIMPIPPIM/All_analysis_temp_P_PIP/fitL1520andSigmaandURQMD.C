...
int fitL1520andSigmaandURQMD(void)
{
  ...
  TH1F* h_pt_data_clean_urqmd=h_pt_data_clean->Clone("h_pt_data_clean_urqmd");
  h_pt_data_clean_urqmd->Add(h_pt_urqmd,-1);
  TH1F* h_w_data_clean_urqmd=h_w_data_clean->Clone("h_w_data_clean_urqmd");
  h_w_data_clean_urqmd->Add(h_w_urqmd,-1);
  ...
  h_pt_data_clean_urqmd->Write();
  h_w_data_clean_urqmd->Write();
