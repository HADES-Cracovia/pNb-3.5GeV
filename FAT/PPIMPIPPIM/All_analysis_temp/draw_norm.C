...
void setHistogramStyleThermal(TH1* hist)
{
...
int draw_norm(void)
{
  ...
  //TFile *fileL1520thermal=new TFile("SB_sim_L1520thermal.root","READ");
  TFile *fileL1520thermal=new TFile("SB_sim_L1520thermal_125_600.root","READ");
  ...
  TH1F *hthermal_background=(TH1F*)fileL1520thermal->Get("background");
  hthermal_background->SetName("hthermal_background");
  hthermal_background->Sumw2(kFALSE);
  ...
  TH1F *hL1520thermal_L1520_w=(TH1F*)fileL1520thermal->Get("hL1520_w");
  hL1520thermal_L1520_w->SetName("hL1520thermal_L1520_w");
  hL1520thermal_L1520_w->Sumw2(kFALSE);
  ...
  TH1F *hL1520thermal_L1520_pt=(TH1F*)fileL1520thermal->Get("hL1520_pt");
  hL1520thermal_L1520_pt->SetName("hL1520thermal_L1520_pt");
  hL1520thermal_L1520_pt->Sumw2(kFALSE);
  ...
  //p and theta in CM
  TH1F *hexperiment_L1520_p=(TH1F*)fileExp->Get("hL1520_p");
  hexperiment_L1520_p->SetName("hexperiment_L1520_p");
  hexperiment_L1520_p->Sumw2();
  TH1F *hL1520_L1520_p=(TH1F*)fileL1520->Get("hL1520_p");
  hL1520_L1520_p->SetName("hL1520_L1520_p");
  hL1520_L1520_p->Sumw2(kFALSE);
  TH1F *hLDpp_L1520_p=(TH1F*)fileExp->Get("hL1520_p");
  hLDpp_L1520_p->SetName("hLDpp_L1520_p");
  hLDpp_L1520_p->Sumw2(kFALSE);
  TH1F *hSDpp_L1520_p=(TH1F*)fileExp->Get("hL1520_p");
  hSDpp_L1520_p->SetName("hSDpp_L1520_p");
  hSDpp_L1520_p->Sumw2(kFALSE);
  TH1F *hS1385_L1520_p=(TH1F*)fileExp->Get("hL1520_p");
  hS1385_L1520_p->SetName("hS1385_L1520_p");
  hS1385_L1520_p->Sumw2(kFALSE);

  TH1F *hexperiment_L1520_p_SB=(TH1F*)fileExp->Get("hL1520_p_SB");
  hexperiment_L1520_p_SB->SetName("hexperiment_L1520_p_SB");
  hexperiment_L1520_p_SB->Sumw2();
  TH1F *hL1520_L1520_p_SB=(TH1F*)fileL1520->Get("hL1520_p_SB");
  hL1520_L1520_p_SB->SetName("hL1520_L1520_p_SB");
  hL1520_L1520_p_SB->Sumw2(kFALSE);
  TH1F *hLDpp_L1520_p_SB=(TH1F*)fileExp->Get("hL1520_p_SB");
  hLDpp_L1520_p_SB->SetName("hLDpp_L1520_p_SB");
  hLDpp_L1520_p_SB->Sumw2(kFALSE);
  TH1F *hSDpp_L1520_p_SB=(TH1F*)fileExp->Get("hL1520_p_SB");
  hSDpp_L1520_p_SB->SetName("hSDpp_L1520_p_SB");
  hSDpp_L1520_p_SB->Sumw2(kFALSE);
  TH1F *hS1385_L1520_p_SB=(TH1F*)fileExp->Get("hL1520_p_SB");
  ...
  TH1F *hclean_p_background=(TH1F*)hSDpp_L1520_p_SB->Clone("hclean_p_background");
  ...
  hsum_theta_background->Reset();
  hsum_p_background->Reset();
  hsum_theta_background_SB->Reset();
  hsum_p_background_SB->Reset();
  hclean_theta_background->Reset();
  hclean_p_background->Reset();
  ...
  hthermal_background->Scale(cs[3]);
  ...
  */
  ...
  hS1385_L1520_p_SB->Scale(cs[0]);
  hSDpp_L1520_p_SB->Scale(cs[1]);
  hLDpp_L1520_p_SB->Scale(cs[2]);
  hL1520_L1520_p_SB->Scale(cs[3]);
  hS1385_L1520_theta_SB->Scale(cs[0]);
  hSDpp_L1520_theta_SB->Scale(cs[1]);
  hLDpp_L1520_theta_SB->Scale(cs[2]);
  hL1520_L1520_theta_SB->Scale(cs[3]);
  hS1385_L1520_p->Scale(cs[0]);
  hSDpp_L1520_p->Scale(cs[1]);
  hLDpp_L1520_p->Scale(cs[2]);
  hL1520_L1520_p->Scale(cs[3]);
  hS1385_L1520_theta->Scale(cs[0]);
  hSDpp_L1520_theta->Scale(cs[1]);
  hLDpp_L1520_theta->Scale(cs[2]);
  hL1520_L1520_theta->Scale(cs[3]);

  scale_error(hS1385_L1520_p_SB,err[0]);
  scale_error(hSDpp_L1520_p_SB,err[1]);
  scale_error(hLDpp_L1520_p_SB,err[2]);
  scale_error(hL1520_L1520_p_SB,err[3]);
  scale_error(hS1385_L1520_theta_SB,err[0]);
  scale_error(hSDpp_L1520_theta_SB,err[1]);
  scale_error(hLDpp_L1520_theta_SB,err[2]);
  scale_error(hL1520_L1520_theta_SB,err[3]);
  scale_error(hS1385_L1520_p,err[0]);
  scale_error(hSDpp_L1520_p,err[1]);
  scale_error(hLDpp_L1520_p,err[2]);
  scale_error(hL1520_L1520_p,err[3]);
  scale_error(hS1385_L1520_theta,err[0]);
  scale_error(hSDpp_L1520_theta,err[1]);
  scale_error(hLDpp_L1520_theta,err[2]);
  scale_error(hL1520_L1520_theta,err[3]);
  ...
  */
  ...
  scale_error(hL1520thermal_data,err[3]);
  ...
  scale_error(hL1520thermal_L1520_pt,err[3]);
  ...
  scale_error(hL1520thermal_L1520_w,err[3]);
  ...
  hsum_p_background_SB->Add(hS1385_L1520_p_SB);
  hsum_p_background_SB->Add(hSDpp_L1520_p_SB);
  hsum_p_background_SB->Add(hLDpp_L1520_p_SB);

  hsum_theta_background_SB->Add(hS1385_L1520_theta_SB);
  hsum_theta_background_SB->Add(hSDpp_L1520_theta_SB);
  hsum_theta_background_SB->Add(hLDpp_L1520_theta_SB);
  
  hsum_p_background->Add(hS1385_L1520_p);
  hsum_p_background->Add(hSDpp_L1520_p);
  hsum_p_background->Add(hLDpp_L1520_p);

  hsum_theta_background->Add(hS1385_L1520_theta);
  hsum_theta_background->Add(hSDpp_L1520_theta);
  hsum_theta_background->Add(hLDpp_L1520_theta);
  ...
  hclean_w_EM->Add(hEM_L1520_w,hEM_L1520_w_SB,1,-1);
    ...
    hclean_theta_background->Add(hsum_theta_background,hsum_theta_background_SB,1,-1);
  hclean_p_background->Add(hsum_p_background,hsum_p_background_SB,1,-1);
  hclean_theta_L1520->Add(hL1520_L1520_theta,hL1520_L1520_theta_SB,1,-1);
  ...
  double int_min_2=int_min_1;//1700;
  ...
  hclean_p_L1520->Scale((experiment_int-backgroud_int)/sig_int);
  hclean_theta_L1520->Scale((experiment_int-backgroud_int)/sig_int);

  
  cout<<endl<<endl<<"*** Drawing all results ***"<<endl;

  gStyle->SetErrorX(0.29);// 1/Sqrt(12) - a bin position uncertentity
  ...
  TLine* line_Ptmean=new TLine(hclean_pt_experiment->GetMean(),0,hclean_pt_experiment->GetMean(),line_h);
  line_Ptmean->SetLineWidth(4);
  line_Ptmean->SetLineColor(kBlue+1);
  ...
  hPP_pt->Draw("same");
  hPP_pt->SetLineColor(kRed);
  hPP_pt->SetMarkerColor(kRed);
  hPP_pt->Scale(hclean_pt_experiment->GetBinContent(hclean_pt_experiment->GetMaximumBin())/hPP_pt->GetBinContent(hPP_pt->GetMaximumBin()));
  ...
  */
  ...
  TLine* line_Wmean=new TLine(hclean_w_experiment_sum->GetMean(),0,hclean_w_experiment_sum->GetMean(),line_h);
  line_Wmean->SetLineWidth(4);
  line_Wmean->SetLineColor(kBlue+1);
  ...
  hclean_w_experiment_sum->GetXaxis()->SetRangeUser(0.1,1.5);
  ...
  line_Wmean->Draw();
  hPP_w->Draw("same");
  hPP_w->SetLineColor(kRed);
  hPP_w->SetMarkerColor(kRed);
  hPP_w->Scale(hclean_w_experiment->GetBinContent(hclean_w_experiment->GetMaximumBin())/hPP_w->GetBinContent(hPP_w->GetMaximumBin()));
  ...
  */
  ...
  line_Wmean_pp->SetLineWidth(4);
  line_Wmean_pp->SetLineColor(kRed+1);
  line_Wmean_pp->SetLineStyle(10); 
  ...
  int rebin2=4; //wrong error propagation for simul events
...
/*
  ...
  */
  ...
  hclean_experiment->GetXaxis()->SetRangeUser(1360,1700);
  setHistogramStyleData(hclean_experiment);
  hPP_L1520->Draw("same");
  hPP_L1520->SetLineColor(kRed);
  hPP_L1520->SetMarkerColor(kRed);
  hPP_L1520->Scale(hclean_experiment->GetBinContent(hclean_experiment->GetMaximumBin())/hPP_L1520->GetBinContent(hPP_L1520->GetMaximumBin()));
  hL1520thermal_data->Rebin(2);
  hL1520thermal_data->Scale(hclean_experiment->GetBinContent(hclean_experiment->GetMaximumBin())/hL1520thermal_data->GetBinContent(hL1520thermal_data->GetMaximumBin()));
  hL1520thermal_data->Draw("same");
  hL1520thermal_data->SetLineColor(kMagenta);
  /*
  ...
  */
  ...
  setHistogramStyleData(hEM_data_sclad);
  hEM_data_sclad->Draw("same");
  hEM_data_sclad->Rebin(rebin2);

  cWithoutSB->cd(2);
  TF1* voigt2= new TF1("voigt2","[0]*TMath::Voigt(x-[1],[2],[3],4)",1380,1750);
  h1520_exp_EM->Draw();
  h1520_exp_EM->Rebin(rebin2);
  ...
  h1520_exp_EM->SetAxisRange(1350,1800);
  hLambda1520_INCL->Draw("same");
  hLambda1520_INCL->SetLineColor(kMagenta);
  ...
  hMPPimPim->Rebin(rebin2);
  hMPPimPim_EM->Rebin(rebin2);
  hMPPimPim_clean->Rebin(rebin2);
  hMPPimPip->Rebin(rebin2);
  hMPPimPip_EM->Rebin(rebin2);
  hMPPimPip_clean->Rebin(rebin2);
  ...
  h2MPPimPip_MPPimPim->GetXaxis()->SetRangeUser(1220,1460);
  h2MPPimPip_MPPimPim->GetYaxis()->SetRangeUser(1220,1460);

  cSigma->cd(4);
  h2MPPimPip_MPPimPim_clean->Draw("colz");
  h2MPPimPip_MPPimPim_clean->GetXaxis()->SetRangeUser(1220,1460);
  h2MPPimPip_MPPimPim_clean->GetYaxis()->SetRangeUser(1220,1460);

  TCanvas *cSigma_simul=new TCanvas("cSigma_simul","cSigma_simul");

  hMPPimPip_S1385pK0->Rebin(rebin2);
  hMPPimPim_S1385pK0->Rebin(rebin2);
  hMPPimPim_L1520pippim->Rebin(rebin2);
  hMPPimPip_L1520pippim->Rebin(rebin2);
  
  cSigma_simul->Divide(2);
  cSigma_simul->cd(1);
  hMPPimPim_clean->Draw("e1");
  hMPPimPim_clean->SetAxisRange(1200,1500);
  //S1385 K0 p
  hMPPimPim_S1385pK0->SetLineColor(kRed);
  setHistogramStyleData(hMPPimPim_S1385pK0);
  hMPPimPim_S1385pK0->Scale(hMPPimPim_clean->Integral(hMPPimPim_clean->FindBin(1100),hMPPimPim_clean->FindBin(1600))
				  /hMPPimPim_S1385pK0->Integral(hMPPimPim_S1385pK0->FindBin(1100),hMPPimPim_S1385pK0->FindBin(1600)));
  hMPPimPim_S1385pK0->Draw("same");

  
  //L1520 K+ p
  hMPPimPim_L1520pippim->SetLineColor(kBlue);
  setHistogramStyleData(hMPPimPim_L1520pippim);
  hMPPimPim_L1520pippim->Scale(hMPPimPim_clean->Integral(hMPPimPim_clean->FindBin(1100),hMPPimPim_clean->FindBin(1600))
				  /hMPPimPim_L1520pippim->Integral(hMPPimPim_L1520pippim->FindBin(1100),hMPPimPim_L1520pippim->FindBin(1600)));
  hMPPimPim_L1520pippim->Draw("same");
  
  cSigma_simul->cd(2);
  hMPPimPip_clean->Draw("e1");
  hMPPimPip_clean->SetAxisRange(1200,1500);

  //S1385 K0 p
  hMPPimPip_S1385pK0->SetLineColor(kRed);
  setHistogramStyleData(hMPPimPip_S1385pK0);
  hMPPimPip_S1385pK0->Scale(hMPPimPip_clean->Integral(hMPPimPip_clean->FindBin(1100),hMPPimPip_clean->FindBin(1600))
				  /hMPPimPip_S1385pK0->Integral(hMPPimPip_S1385pK0->FindBin(1100),hMPPimPip_S1385pK0->FindBin(1600)));
  hMPPimPip_S1385pK0->Draw("same");

  //L1520 K+ p
  hMPPimPip_L1520pippim->SetLineColor(kBlue);
  setHistogramStyleData(hMPPimPip_L1520pippim);
