...
// from TTree ppimpippim_LM/ppimpippim_LM
// found on file: pNb_ppimpippim_LM_full_chi2_LM_pippimM_tlo.root
//////////////////////////////////////////////////////////

#ifndef ppimpippim_LM_h
#define ppimpippim_LM_h
...
public :
  ...
  ppimpippim_LM(TTree *tree=0);
  virtual ~ppimpippim_LM();
...
#ifdef ppimpippim_LM_cxx
ppimpippim_LM::ppimpippim_LM(TTree *tree) : fChain(0) 
{
...
ppimpippim_LM::~ppimpippim_LM()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t ppimpippim_LM::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t ppimpippim_LM::LoadTree(Long64_t entry)
{
...
void ppimpippim_LM::Init(TTree *tree)
{
...
void ppimpippim_LM::Show(Long64_t entry)
{
...
Int_t ppimpippim_LM::Cut(Long64_t entry)
{  
...
void ppimpippim_LM::FitK0(TH1F*hist, TF1 *sig, TF1* bg, TF1* sig_bg)
{
...
void ppimpippim_LM::FitL1115(TH1F*hist, TF1 *sig, TF1* bg, TF1* sig_bg)
{
