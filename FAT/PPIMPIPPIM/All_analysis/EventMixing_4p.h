...
#ifndef EventMixing_4p_h
#define EventMixing_4p_h
...
public :
  ...
  EventMixing_4p(TTree *tree=0);
  virtual ~EventMixing_4p();
...
#ifdef EventMixing_4p_cxx
EventMixing_4p::EventMixing_4p(TTree *tree) : fChain(0) 
{
...
EventMixing_4p::~EventMixing_4p()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t EventMixing_4p::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t EventMixing_4p::LoadTree(Long64_t entry)
{
...
void EventMixing_4p::Init(TTree *tree)
{
...
void EventMixing_4p::Show(Long64_t entry)
{
...
Int_t EventMixing_4p::Cut(Long64_t entry)
{
...
Int_t EventMixing_4p::CutLK0(Long64_t entry)
{
  // This function may be called from Loop.
  // returns  1 if entry is accepted.
  // returns -1 otherwise.
