...
namespace PATData {
  ...
  extern TH1F *m_pim_p_ZD, *m_pim_p_ep_em_ZD, *m_pim_p_ep_em_ZD_RF, *m_pim_p_ep_em_ZD_BT;
  ...
  extern TH2F *ep_beta_mom, *em_beta_mom,*ep_beta_mom_bt, *em_beta_mom_bt, *pureBT_beta_mom, *pim_beta_mom, *p_beta_mom;
