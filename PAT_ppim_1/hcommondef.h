...
enum EParticle { eUnknown=0, ePositron=2, eElectron=3, ePiPlus=8, ePiMinus=9, 
                 eProton=14, eDeuteron=45, eTritium=46, eAlpha=47, eHe3=49,
                 eLeptonPos=102, eLeptonNeg=103, eHadronPos=104, eHadronNeg=105 };
